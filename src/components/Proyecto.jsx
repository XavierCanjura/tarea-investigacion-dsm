...
const Proyecto = () => {
    return (
        <>
            <div className='px-[5%] mt-[5%] py-[6%] md:h-[100vh] bg-primary' id='Proyecto'>
                <div className=''>
                    <div className='flex flex-row flex-wrap'>
                        ...
                        <div  className='w-full md:w-[65%] xl:w-[65%] h-auto flex flex-col  text-white'>
                            ...
                            <br />
                            <p className='text-md md:text-xl text-justify'>Vax Pet va dirigia a las personas que desean llevar el seguimiento de cada control realizado en la veterinaria con respectoa las citas programadas, vacunacion y desoarasitación de cada mascota.</p>
                            <br />

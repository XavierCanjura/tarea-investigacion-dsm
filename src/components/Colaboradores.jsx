...
const data = [
    ...
    },
    {
        ...
        descripcion: `¡Hola! Soy Ruby, una ingeniera en ciencias de la computación que ha trabajado como desarrolladora full stack. Nací en El Salvador y desde muy joven tuve un gran interés en la tecnología y la informática.<br><br>Recuerdo que cuando era niña me encantaba desarmar y volver a armar los dispositivos electrónicos que tenía en casa, lo que me llevó a explorar mi pasión por la programación.Cuando llegó el momento de elegir una carrera universitaria, no lo dudé y elegí la ingeniería en ciencias de la computación en la Universidad Don Bosco. Durante mi carrera, aprendí habilidades técnicas en programación, diseño de bases de datos y otras herramientas útiles para el desarrollo de software.<br><br>En mi tercer año de mi carrera, comencé a trabajar como desarrolladora full stack, donde tuve la oportunidad de aplicar mis habilidades y conocimientos en proyectos significativos. Algunos de mis proyectos más destacados incluyen el Observatorio de Desigualdad Multidimensional de El Salvador, donde contribuí en la creación de pruebas automatizadas y diseño de base de datos y migraciones.<br><br>Además de mi trabajo, también me gusta seguir aprendiendo y explorando nuevas tecnologías y herramientas para mejorar mis habilidades como desarrolladora full stack. Mi objetivo a largo plazo es crear mi propio emprendimiento aplicando todo lo que he aprendido y experimentado a lo largo de mi carrera.<br><br>En resumen, soy una apasionada de la tecnología y la informática que busca seguir creciendo y aprendiendo en mi carrera. Estoy emocionada por ver lo que el futuro me depara y por continuar desarrollando habilidades útiles y significativas en el campo de la informática.`,
        proyectos: [],
    },
    {
        img: imgDaniel,
